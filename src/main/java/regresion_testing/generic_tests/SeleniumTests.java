...
public class SeleniumTests {
	 ...
	 * @return
	 */
	public TestResult searchTest(WebDriver driver, String url, String field,
			String value) {
	 ...
	 * @return
	 */
	public TestResult checkTest(WebDriver driver, String url, String field,
			String value) {
	 ...
	 * @return
	 */
	public TestResult comboboxTest(WebDriver driver, String url, String field,
			String value) {
